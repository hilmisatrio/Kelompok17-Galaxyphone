...
class Kategori_Produk
{
    ...
    public function read()
    {
        ...
        $query = 'SELECT kategori_produk.id as id, kategori_produk.produk_id as produk_id, kategori_produk.kategori_id as kategori_id,
                                 produk.nama as nama_produk, kategori.type as type_produk, kategori.merek as merek_produk FROM ((' . $this->table . ' INNER JOIN produk 
                                ON kategori_produk.produk_id = produk.id) INNER JOIN kategori ON kategori_produk.kategori_id = kategori.id);';
    ...
    public function read_single()
    {
        // Create query
        $query = 'SELECT kategori_produk.id as id, kategori_produk.produk_id as produk_id, kategori_produk.kategori_id as kategori_id,
                                    produk.nama as nama_produk, kategori.type as type_produk, kategori.merek as merek_produk FROM 
